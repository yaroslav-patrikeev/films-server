Вот файл `README.md` с описанием работы ручки `POST /film`:
...
Этот README.md содержит полную документацию по эндпоинту, включая все параметры, примеры запросов и ответов, а также все возможные ошибки с пояснениями.
```
